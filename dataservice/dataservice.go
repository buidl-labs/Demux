...
func NewClient(cnf *MongoConfig) (ClientHelper, error) {
...
func NewDatabase(cnf *MongoConfig, client ClientHelper) DatabaseHelper {
...
type CRUD interface {
	Create(yourModel struct{}) error
	Read(id string) []struct{}
	Update(yourModel struct{}) error
	Delete(yourModel struct{}) error
}
